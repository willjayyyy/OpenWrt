...
sed -i "s|firmware_repo.*|firmware_repo 'https://github.com/willjayyyy/OpenWrt'|g" package/luci-app-amlogic/root/etc/config/amlogic
...
# feeds update 会恢复之前删除的包，需要重新删除源目录和 symlink
rm -rf feeds/luci/applications/luci-app-argon-config
./scripts/feeds install -a
# feeds install 可能重建 broken symlink，彻底删除以避免与 package/ 下的自定义版本冲突
